...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.2], #utilizamos 0.2 dado que da el mejor valor
              'n_estimators': [77]} #utilizamos 77 dado que da el mejor valor
...
clasificador.fit(X_smoteSpainFrance, y_smoteSpainFrance, **fit_parametros)
