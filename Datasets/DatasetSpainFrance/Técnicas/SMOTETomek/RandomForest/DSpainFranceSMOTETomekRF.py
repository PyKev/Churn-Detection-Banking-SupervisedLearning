...
parametros = {'n_estimators': [67], # Los valores probados en este parámetro fueron: 18,27,45,67,89. Y seleccionamos el que se muestra ahora.
...
BA_model.fit(X_smote_tomekSpainFrance, y_smote_tomekSpainFrance)
