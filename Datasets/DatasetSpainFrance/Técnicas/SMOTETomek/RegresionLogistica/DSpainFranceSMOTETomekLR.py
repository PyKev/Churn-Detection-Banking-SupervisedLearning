...
RLmodel.fit(X_smote_tomekSpainFrance, y_smote_tomekSpainFrance)
print(RLmodel.best_params_, ":",RLmodel.scoring)
RLmodel.score(X_testSpainFrance, y_testSpainFrance)
y_pred = RLmodel.predict(X_testSpainFrance)
