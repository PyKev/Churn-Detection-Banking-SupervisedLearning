...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.152], #utilizamos 0.152 dado que da el mejor valor
              'n_estimators': [80]} #utilizamos 80 dado que da el mejor valor
...
clasificador.fit(X_smoteFranceGermany, y_smoteFranceGermany, **fit_parametros)
