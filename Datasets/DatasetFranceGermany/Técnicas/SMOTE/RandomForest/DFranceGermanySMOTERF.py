...
parametros = {'n_estimators': [88], # Los valores probados en este parámetro fueron: 22,44,66,88. Y seleccionamos el que se muestra ahora.
...
BA_model.fit(X_smoteFranceGermany, y_smoteFranceGermany)
