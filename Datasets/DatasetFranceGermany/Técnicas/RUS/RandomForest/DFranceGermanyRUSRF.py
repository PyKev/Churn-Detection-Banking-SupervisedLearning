...
parametros = {'n_estimators': [84], # Los valores probados en este parámetro fueron: 12,34,55,84,91. Y seleccionamos el que se muestra ahora.
...
BA_model.fit(X_rusFranceGermany, y_rusFranceGermany)
