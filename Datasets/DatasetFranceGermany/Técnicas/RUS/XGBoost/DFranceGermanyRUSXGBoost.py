...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.151975], #utilizamos 0.151975 dado que da el mejor valor
              'n_estimators': [40]} #utilizamos 40 dado que da el mejor valor
...
clasificador.fit(X_rusFranceGermany, y_rusFranceGermany, **fit_parametros)
