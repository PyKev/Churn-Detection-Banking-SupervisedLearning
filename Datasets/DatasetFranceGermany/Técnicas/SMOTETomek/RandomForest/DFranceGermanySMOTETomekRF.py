...
parametros = {'n_estimators': [55], # Los valores probados en este parámetro fueron: 12,34,55,84,91. Y seleccionamos el que se muestra ahora.
...
BA_model.fit(X_smote_tomekFranceGermany, y_smote_tomekFranceGermany)
