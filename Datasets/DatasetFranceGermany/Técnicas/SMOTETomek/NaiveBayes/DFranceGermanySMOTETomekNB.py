...
parametros = {'var_smoothing': [0.0001519911082952933]} # Los valores probados en este parámetro
...
NB_model.fit(X_smote_tomekFranceGermany, y_smote_tomekFranceGermany)
