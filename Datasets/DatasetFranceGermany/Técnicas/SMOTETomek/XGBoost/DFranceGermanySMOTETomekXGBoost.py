...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.263105], #utilizamos 0.255 dado que da el mejor valor
...
clasificador.fit(X_smote_tomekFranceGermany, y_smote_tomekFranceGermany, **fit_parametros)
