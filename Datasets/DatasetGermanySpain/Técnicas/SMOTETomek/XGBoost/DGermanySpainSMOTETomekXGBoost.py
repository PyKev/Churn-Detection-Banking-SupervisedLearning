...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.23], #utilizamos 0.23 dado que da el mejor valor
              'n_estimators': [57]} #utilizamos 57 dado que da el mejor valor
...
clasificador.fit(X_smote_tomekGermanySpain, y_smote_tomekGermanySpain, **fit_parametros)
