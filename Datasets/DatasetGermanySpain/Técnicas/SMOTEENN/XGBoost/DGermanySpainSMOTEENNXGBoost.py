...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.11], #utilizamos 0.11 dado que da el mejor valor
              'n_estimators': [31]} #utilizamos 31 dado que da el mejor valor
...
clasificador.fit(X_smote_ennGermanySpain, y_smote_ennGermanySpain, **fit_parametros)
