...
parametros = {'n_estimators': [80], # Los valores probados en este parámetro fueron: 10,30,50,80,95. Y seleccionamos el que se muestra ahora.
              'min_samples_leaf': [20], # Los valores probados en este parámetro fueron: 2,6,10,14,20. Y seleccionamos el que se muestra ahora.
             }
...
BA_model.fit(X_smote_ennGermany, y_smote_ennGermany)
