...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.095], #utilizamos 0.095 dado que da el mejor valor
              'n_estimators': [70]} #utilizamos 70 dado que da el mejor valor
...
clasificador.fit(X_smoteGermany, y_smoteGermany, **fit_parametros)
