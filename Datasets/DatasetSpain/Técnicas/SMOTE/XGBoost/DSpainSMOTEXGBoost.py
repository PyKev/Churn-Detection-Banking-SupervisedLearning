...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.9], #utilizamos 0.9 dado que da el mejor valor
              'n_estimators': [5]} #utilizamos 5 dado que da el mejor valor
...
clasificador.fit(X_smoteSpain, y_smoteSpain, **fit_parametros)
