...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.26], #utilizamos 0.26 dado que da el mejor valor
              'n_estimators': [30]} #utilizamos 30 dado que da el mejor valor
...
clasificador.fit(X_smote_tomekSpain, y_smote_tomekSpain, **fit_parametros)
