...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.1], #utilizamos 0.1 dado que da el mejor valor
              'n_estimators': [54]} #utilizamos 54 dado que da el mejor valor
...
clasificador.fit(X_rusGeneral, y_rusGeneral, **fit_parametros)
