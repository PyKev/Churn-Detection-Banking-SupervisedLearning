...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.52], #utilizamos 0.52 dado que da el mejor valor
              'n_estimators': [27]} #utilizamos 27 dado que da el mejor valor
...
clasificador.fit(X_smote_ennGeneral, y_smote_ennGeneral, **fit_parametros)
