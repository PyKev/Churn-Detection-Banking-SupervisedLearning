...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.2], #utilizamos 0.20 dado que da el mejor valor
              'n_estimators': [10]} #utilizamos 10 dado que da el mejor valor
...
clasificador.fit(X_rusFrance, y_rusFrance, **fit_parametros)
