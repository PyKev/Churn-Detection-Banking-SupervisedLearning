...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.153005], #utilizamos 0.153005 dado que da el mejor valor
              'n_estimators': [85]} #utilizamos 85 dado que da el mejor valor
...
clasificador.fit(X_smote_tomekFrance, y_smote_tomekFrance, **fit_parametros)
