...
parametros = {'nthreads' : [1],
              ...
              'learning_rate': [0.80], #utilizamos 0.80 dado que da el mejor valor
              'n_estimators': [13]} #utilizamos 13 dado que da el mejor valor
...
clasificador.fit(X_smoteFrance, y_smoteFrance, **fit_parametros)
